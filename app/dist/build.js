...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__XhrRequest__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_bd26cd6c_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(32);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_bd26cd6c_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
var update = __webpack_require__(1)("6c6b34c3", content, true);
...
// module
exports.push([module.i, "#app{font-family:Avenir,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;max-width:628px;color:#2c3e50;margin:60px auto 0}h1{font-weight:400;margin-bottom:1em}p{font-size:1em}#mic-button{margin:20px 0}", ""]);
...
var _speechRecognition = __webpack_require__(25);

var _speechRecognition2 = _interopRequireDefault(_speechRecognition);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var sr = new _speechRecognition2.default(); //
//
//
//
//
...
exports.default = {
  ...
  methods: {
    listen: function listen() {
      ...
      this.listening = true;
      sr.startStream().then(function (data) {
        _this.listening = false;
        _this.result = data.result.resolvedQuery;
    ...
    search: function search(val) {
      ...
      sr.searchByText(val).then(function (data) {
        console.log(data);
        _this2.result = data.result.resolvedQuery;
        window.open('http://dose.com/tagged/' + data.result.parameters.tag, '_blank');
      }).catch(function (err) {
        _this2.error = err;
      });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Button_vue__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Button_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Button_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_006f2619_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Button_vue__ = __webpack_require__(19);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_006f2619_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Button_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("fabe1154", content, true);
...
// module
exports.push([module.i, ".listening{color:#2ecc71}", ""]);
...
exports.default = {
  name: 'mic-button',
  props: ['listen', 'result', 'listening', 'search'],
  computed: {
    res: function res() {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "type": "text",
      "placeholder": "Dose, show me music..."
    },
    domProps: {
      "value": (_vm.res)
    },
    on: {
      "keypress": _vm.handleSearch,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Loader_vue__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_067e530c_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Loader_vue__ = __webpack_require__(24);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_067e530c_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Loader_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("4876fe2c", content, true);
...
// module
exports.push([module.i, ".spinner{width:40px;height:40px;position:relative;float:right;margin:0 auto}.double-bounce1,.double-bounce2{width:100%;height:100%;border-radius:50%;background-color:#2ecc71;opacity:.6;position:absolute;top:0;left:0;-webkit-animation:sk-bounce 2s infinite ease-in-out;animation:sk-bounce 2s infinite ease-in-out}.double-bounce2{-webkit-animation-delay:-1s;animation-delay:-1s}@-webkit-keyframes sk-bounce{0%,to{-webkit-transform:scale(0)}50%{-webkit-transform:scale(1)}}@keyframes sk-bounce{0%,to{transform:scale(0);-webkit-transform:scale(0)}50%{transform:scale(1);-webkit-transform:scale(1)}}", ""]);
...
var _apiAiJavascript = __webpack_require__(26);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var client = new _apiAiJavascript.ApiAiClient({
...
var SpeechRecognition = function () {
  ...
  _createClass(SpeechRecognition, [{
    ...
    value: function startStream() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.recognition.onresult = function (event) {
          client.textRequest(event.results[0][0].transcript).then(function (response) {
            if (response.result.metadata.intentName === 'show') resolve(response);else reject({ msg: 'Command not available. Try "Dose, show me music"' });
          }).catch(function (err) {
            reject(err);
          });
        };
    ...
    value: function searchByText(text) {
      return new Promise(function (resolve, reject) {
        client.textRequest(text).then(function (response) {
          if (response.result.metadata.intentName === 'show') resolve(response);else reject({ msg: 'Command not available. Try "Dose, show me music"' });
        }).catch(function (err) {
          reject(err);
        });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__es6_ApiAiClient__ = __webpack_require__(27);
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ApiAiConstants", function() { return __WEBPACK_IMPORTED_MODULE_0__es6_ApiAiClient__["b"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ApiAiClient", function() { return __WEBPACK_IMPORTED_MODULE_0__es6_ApiAiClient__["a"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "IStreamClient", function() { return __WEBPACK_IMPORTED_MODULE_0__es6_ApiAiClient__["c"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ApiAiConstants__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Errors__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Request_EventRequest__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Request_TextRequest__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Interfaces__ = __webpack_require__(31);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_4__Interfaces__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__ApiAiConstants__["a"]; });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return IStreamClient; });
var IStreamClient;
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("×")])]), _vm._v(" "), _c('strong', [_vm._v("Warning!")]), _vm._v(" " + _vm._s(this.error.msg) + "\n  ")]) : _vm._e(), _vm._v(" "), _c('mic-button', {
    attrs: {
      "listen": _vm.listen,
      "listening": _vm.listening,
      "result": _vm.result,
  ...
  }), _vm._v(" "), _c('br'), _vm._v(" "), _c('p', [_vm._v("Click the microphone button to say a command or type one into the textbox. Commands should take the form \"Dose, show me <something>...\"")]), _vm._v(" "), _vm._m(0)], 1)
}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('p', [_vm._v("Created for the "), _c('a', {
    attrs: {
      "href": "https://github.com/dosemedia/dev_coding_challenge"
    }
  }, [_vm._v("Dose dev coding challenge")])])
}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js!../../../sass-loader/lib/loader.js!./bootstrap.css", function() {
			var newContent = require("!!../../../css-loader/index.js!../../../sass-loader/lib/loader.js!./bootstrap.css");
